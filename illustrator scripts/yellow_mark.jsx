...
(function () {
  ...
  // ===== Settings =====
  var RECT_NAME = "yellow_mark";     // helper item name
  var GROUP_NAME = "yellow_mark_group";
  ...
  var MOVE_DX = 20;                        // move right by 20 pt (negative = left)
  ...
  for (var j = 0; j < toMove.length; j++) {
    try {
      toMove[j].fillColor = '#ffffff';
      toMove[j].selected = true;
      moved++;
    } catch (err) {
      failed++;
    }
